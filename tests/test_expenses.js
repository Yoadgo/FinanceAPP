...
/* ── monthKey קורא בשעון ישראל, לא בשעון הדפדפן ──
   הגיליון שומר חצות-ישראל כ-UTC. `getMonth()` המקומי היה נותן ליועד
   תשובה נכונה ולבדיקה שרצה ב-UTC תשובה אחרת — אותו קובץ, שני חודשים. */
ok('21:00Z ב-31.5 הוא יוני', E.monthKey('2026-05-31T21:00:00.000Z') === '06/2026',
   E.monthKey('2026-05-31T21:00:00.000Z'));
ok('21:00Z ב-31.12 הוא ינואר הבא', E.monthKey('2025-12-31T22:00:00.000Z') === '01/2026',
   E.monthKey('2025-12-31T22:00:00.000Z'));
ok('תאריך בלי שעה נחתך כטקסט', E.monthKey('2026-07-02') === '07/2026');
ok('פלט הפרסר', E.monthKey('02/07/2026') === '07/2026');
ok('זבל → מקף', E.monthKey('לא תאריך') === '—');
